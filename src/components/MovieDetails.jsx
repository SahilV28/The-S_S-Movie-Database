...
import { ayncloadmovie, removemovie } from "../store/actions/movieActions";
...
const MovieDetails = () => {
  ...
  return info ? (
    <div
      ...
      className="relative w-full h-[165vh] px-[4%] overflow-x-hidden"
    >
      {/* Part-1 Navigation */}
      ...
      <div className="w-full flex relative">
        ...
        <div className="content ml-10 text-white">
          ...
          <h1 className="text-[18px]  mt-3">Movie Translated</h1>
      ...
      {/* Part-4 recommendation and similarities */}
      <hr className="border-none h-[1px] bg-zinc-500" />
      <h1 className="font-bold text-white text-2xl mt-5 mb-5">Recommendations & Similar stuff</h1>
      <HorizontalCards
